 ...
 * @since 1.0
 */
public class MiraiLogger implements Logger {
    net.mamoe.mirai.utils.MiraiLogger miraiLogger;

    public MiraiLogger(net.mamoe.mirai.utils.MiraiLogger miraiLogger) {
