 ...
 */
package top.spco.util.stream;

import top.spco.util.ArrayUtils;
import top.spco.util.function.Failable;
import top.spco.util.function.FailableConsumer;
import top.spco.util.function.FailableFunction;
import top.spco.util.function.FailablePredicate;
 ...
 * </pre>
 * <p>
 * Using a {@link Streams.FailableStream}, this can be rewritten as follows:
 * </p>
 *
 * <pre>
 * {@code
...
public class Streams {
    ...
    public static class FailableStream<T> {
         ...
         */
        public Streams.FailableStream<T> filter(final FailablePredicate<T, ?> predicate) {
            assertNotTerminated();
         ...
         * @return the new stream
         */
        public <R> Streams.FailableStream<R> map(final FailableFunction<T, R, ?> mapper) {
            assertNotTerminated();
            return new Streams.FailableStream<>(stream.map(Failable.asFunction(mapper)));
        }
    ...
    /**
     * Converts the given {@link Collection} into a {@link Streams.FailableStream}. This is basically a simplified, reduced version
    ...
    /**
     * Converts the given {@link Stream stream} into a {@link Streams.FailableStream}. This is basically a simplified, reduced
