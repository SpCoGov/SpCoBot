...
public class AlipayRequestBuilder extends RequestBuilder {
    private final BizContent bizContent = new BizContent();
    ...
    @Override
    public AlipayRequestBuilder setAppAuthToken(String appAuthToken) {
        return (AlipayRequestBuilder) super.setAppAuthToken(appAuthToken);
    }

    @Override
    public AlipayRequestBuilder setNotifyUrl(String notifyUrl) {
        return (AlipayRequestBuilder) super.setNotifyUrl(notifyUrl);
    }
    ...
    public AlipayRequestBuilder setDiscountableAmount(String discountableAmount) {
    ...
    public AlipayRequestBuilder setUndiscountableAmount(String undiscountableAmount) {
    ...
    public AlipayRequestBuilder setGoodsDetailList(List<GoodsDetail> goodsDetailList) {
    ...
    public AlipayRequestBuilder setOperatorId(String operatorId) {
    ...
    public AlipayRequestBuilder setStoreId(String storeId) {
    ...
    public AlipayRequestBuilder setAlipayStoreId(String alipayStoreId) {
    ...
    public AlipayRequestBuilder setTerminalId(String terminalId) {
    ...
    public AlipayRequestBuilder setExtendParams(ExtendParams extendParams) {
